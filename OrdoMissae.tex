...
\newcommand{\latinS}[1]{\colchunk{\begin{description}\item[\textbf{S.}]{#1}\end{description}}}
\newcommand{\latinM}[1]{\colchunk{\begin{description}\item[\textbf{M.}]{#1}\end{description}}}
\newcommand{\latinV}[1]{\colchunk{\begin{description}\item[\textbf{V.}]{#1}\end{description}}}
\newcommand{\latinR}[1]{\colchunk{\begin{description}\item[\textbf{R.}]{#1}\end{description}}}
\newcommand{\latin}[1]{\colchunk{\begin{description}\item{#1}\end{description}}}
\newcommand{\pol}[1]{\colchunk{\begin{description}\item{#1}\end{description}}\colplacechunks}
\newcommand{\polV}[1]{\colchunk{\begin{description}\item[\textbf{V.}]{#1}\end{description}}\colplacechunks}
\newcommand{\polR}[1]{\colchunk{\begin{description}\item[\textbf{R.}]{#1}\end{description}}\colplacechunks}
\newcommand{\polK}[1]{\colchunk{\begin{description}\item[\textbf{K.}]{#1}\end{description}}\colplacechunks}
\newcommand{\polW}[1]{\colchunk{\begin{description}\item[\textbf{W.}]{#1}\end{description}}\colplacechunks}
...
\begin{document}
	...
	\begin{parcolumns}[colwidths={2=3 in},nofirstindent]{2}
		...
		\textcolor{red}{Skończywszy czytać Ewangelię kapłan całuje mszał i mówi po cichu:}
	...
	\begin{parcolumns}[colwidths={2=3 in},nofirstindent]{2}
		...
		\latinS{\textbf{HOC EST ENIM CORPUS MEUM}}
	...
	\begin{parcolumns}[colwidths={2=3 in},nofirstindent]{2}
		...
		\pol{TO JEST BOWIEM KIELICH KRWI MOJEJ, NOWEGO I WIECZNEGO PRZYMIERZA: KTÓRY ZA WAS I ZA WIELU WYLANY BĘDZIE NA ODPUSZCZENIE GRZECHÓW.}
	...
	\begin{parcolumns}[colwidths={2=3 in},nofirstindent]{2}
		...
		\textit{\textcolor{red}{Po cichej Mszy Św., kapłan klęcząc u stopni ołtarza, mówi z wiernymi poniższe modlitwy. Zaleca się wiernym samodzielne odmawianie tych modlitw także po Mszach Św. uroczystych.}}
		
		\textbf{Salutatio Angelica --- Pozdrowienie Anielskie}
		...
		\textbf{Modlitwa do Św. Michała Archanioła (Egzorcyzm prywatny)}
		...
		\textbf{Wezwanie do Najśw. Serca Pana Jezusa (dodane przez Św. Piusa X)}
